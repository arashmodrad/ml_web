...
## Evolution of Continental Manning's $n$ Modeling


---

## Exploring Roughness in v2.06

To explore the methodology, model architectures, and validation results for Manning's roughness in v2.06:
...
-   :material-forest: **[Overbank / Floodplain Roughness ($n_{\text{out}}$)](../../n/n-out/literature.md)**
    ...
    Floodplain vegetative and topological roughness for 2D flood inundation modeling.
